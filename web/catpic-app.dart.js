...
$$.Widget_runApp_walk = {"":
 ...
 call$1: function(widget) {
  var element = widget.render$0();
  for (var t1 = $.iterator(widget.get$children()); t1.hasNext$0() === true;) {
    var t2 = t1.next$0();
...
$.main = function() {
  var catzLulz = $.Widget$();
  for (var t1 = catzLulz.children, i = 0; i < 20; ++i)
...
$.CTC45 = 'structured clone of ImageData';
